...
3. State file ที่เกี่ยวข้องกับ session domain ถ้ามี (ดูจาก `.claude/agents/secretary.md` domain routing)

---

## Step 0.5 — Save Raw Content

ก่อนสร้าง inventory หรือเขียน wiki page ใดๆ — บันทึก original content ลง `raw/YYYY-MM-DD-slug.md` เสมอ
