---
name: para-router
description: PARA classifier — classify สิ่งใหม่ที่ user พูดถึงเป็น Project/Area/Todo/Resource แล้วให้ user ตัดสินใจก่อน scaffold จริง ใช้เมื่อ user พูดถึงสิ่งใหม่ที่ต้องการ organize หรือเริ่ม project/area ใหม่
