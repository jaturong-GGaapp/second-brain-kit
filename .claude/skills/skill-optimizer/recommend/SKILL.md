---
name: recommend
description: Lens of the Pragmatic Builder สำหรับ skill-optimizer — เสนอ minimum effective change (merge/split/refine/new) พร้อมวิธีทำจริงๆ ไม่ใช่แค่ idea
...
**แนะนำ:** merge | split | refine | new | migrate
